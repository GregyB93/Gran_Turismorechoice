...
class Colour:
    ...
    def colour_cost(self):
        self.colour_price + Car.price
...
TyreFlameRed = Colour("Tyre Flame Red", 100)
...
3. Tyre Flame Red +£100
''')
                    delorean_colour = input("Enter a selection 1 - 3: ")
                    if delorean_colour == "1":
                        Delorean.colour = StandardSilver.name
                        break
                    elif delorean_colour == "2":
                        Delorean.colour = FuturisticFuchsia.name
                        break
                    elif delorean_colour == "3":
                        Delorean.colour = TyreFlameRed.name
                        break
                    else:
